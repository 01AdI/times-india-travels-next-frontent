...
export default function AboutUs_Quotation_Form({ onClose }) {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      console.error(
        "About Us enquiry submission error:",
        error
      );
    ...
    >
      ...
      >
        <div className="relative shrink-0 overflow-hidden bg-[#124d56] px-6 py-7 sm:px-9 sm:py-8">
          ...
          <div className="absolute -left-24 -bottom-32 h-64 w-64 rounded-full bg-white/4 blur-3xl" />

          <div className="absolute left-10 right-10 top-0 h-px bg-linear-to-r from-transparent via-[#F58634] to-transparent opacity-80" />
        ...
        <div className="min-h-0 flex-1 overflow-y-auto">
          {submitStatus !== "success" ? (
            <>
              ...
              {submitStatus === "error" && submitError && (
                <div
                  ...
                  className="mx-5 mt-6 flex items-start gap-3 rounded-2xl border border-red-200 bg-red-50 px-5 py-4 sm:mx-8 lg:mx-9"
                >
                  <AlertCircle
                    size={20}
              ...
              <form
                ...
                className="mx-5 mb-6 mt-6 rounded-3xl border border-[#124d56]/10 bg-white p-5 shadow-[0_10px_40px_rgba(18,77,86,0.05)] sm:mx-8 sm:p-7 lg:mx-9 lg:p-8"
              >
                <div className="grid grid-cols-1 gap-x-5 gap-y-5 sm:grid-cols-2">
                  ...
                  <div>
                    ...
                    <div className="relative w-full">
                      <DatePicker
                        ...
                        disabled={isSubmitting}
                        className="w-full! h-13! rounded-xl! border! border-[#124d56]/15! bg-white! px-4! pr-12! py-3! text-sm! text-[#0B3C49]! placeholder:text-[#124d56]/35! focus:border-[#F58634]! focus:ring-4! focus:ring-[#F58634]/10! outline-none cursor-pointer disabled:cursor-not-allowed"
                        ...
                        renderCustomHeader={({
                          ...
                          <div className="flex h-19 items-center justify-between gap-2 bg-linear-to-br from-[#124d56] to-[#0d3d46] px-3.5 py-3">
                            <button
                              type="button"
                              onClick={decreaseMonth}
                              disabled={prevMonthButtonDisabled}
                              aria-label="Previous month"
                              className="flex h-9.5 w-9.5 shrink-0 items-center justify-center rounded-[10px] border border-white/12 bg-white/6 text-white/85 transition-all duration-200 hover:border-[#F58634]/45 hover:bg-[#F58634]/16 hover:text-[#F58634] disabled:cursor-not-allowed disabled:opacity-25"
                            >
                              <ChevronLeftIcon
                                size={18}
                                strokeWidth={2}
                            ...
                            <div className="flex flex-1 items-center justify-center gap-2">
                              <div className="relative flex items-center">
                                <select
                                  ...
                                  className="h-9.5 min-w-29.5 cursor-pointer appearance-none rounded-[10px] border border-white/14 bg-[#07111f]/45 px-3.25 pr-8 text-[13px] font-semibold text-white outline-none transition-all duration-200 hover:border-[#F58634]/45 focus:border-[#F58634]"
                                >
                                  {MONTH_NAMES.map(
                                    (month, index) => (
                                      <option
                              ...
                              <div className="relative flex items-center">
                                <select
                                  ...
                                  className="h-9.5 min-w-22 cursor-pointer appearance-none rounded-[10px] border border-white/14 bg-[#07111f]/45 px-3.25 pr-8 text-[13px] font-semibold text-white outline-none transition-all duration-200 hover:border-[#F58634]/45 focus:border-[#F58634]"
                                >
                                  {YEAR_OPTIONS.map(
                                    (year) => (
                                      <option
                            ...
                            <button
                              ...
                              className="ml-1.5 flex h-9.5 w-9.5 shrink-0 items-center justify-center rounded-[10px] border border-white/12 bg-white/6 text-white/60 transition-all duration-200 hover:border-white/25 hover:bg-white/12 hover:text-white"
                            >
                  ...
                  >
                    ...
                    <button
                      ...
                      className={`flex h-13 w-full items-center justify-between rounded-xl border bg-white px-4 text-left text-sm transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-[#F58634]/10 disabled:cursor-not-allowed disabled:opacity-60 ${
                        isPackageDropdownOpen
                          ? "border-[#F58634]"
                    ...
                    >
                      ...
                      "loading" ? (
                        <Loader2
                          size={18}
                          className="shrink-0 animate-spin text-[#124d56]/50"
                        />
                      ) : (
                        <ChevronDown
                          size={18}
                          strokeWidth={1.8}
                          className={`shrink-0 text-[#124d56]/55 transition-transform duration-300 ${
                            isPackageDropdownOpen
                              ? "rotate-180"
                              : ""
                          }`}
                    ...
                    {isPackageDropdownOpen && (
                      <div className="absolute left-0 right-0 top-full z-100 mt-2 overflow-hidden rounded-xl border border-[#124d56]/15 bg-white shadow-[0_20px_60px_rgba(0,0,0,0.18)]">
                        <div className="border-b border-[#124d56]/10 p-3">
                          <div className="relative">
                            <Search
                              size={16}
                              strokeWidth={1.8}
                              className="pointer-events-none absolute left-3 top-1/2 -translate-y-1/2 text-[#124d56]/40"
                            />
                            ...
                            <input
                              ...
                              className="h-10 w-full rounded-lg border border-[#124d56]/10 bg-[#F2FAFB] pl-9 pr-9 text-sm text-[#0B3C49] outline-none placeholder:text-[#124d56]/35 focus:border-[#F58634]/60"
                            />
                            ...
                            {packageSearch && (
                              <button
                                ...
                                className="absolute right-2 top-1/2 flex h-7 w-7 -translate-y-1/2 items-center justify-center rounded-md text-[#124d56]/40 transition hover:bg-[#124d56]/5 hover:text-[#124d56]"
                        ...
                        >
                          {tourPackageStatus ===
                            "loading" && (
                            <div className="flex items-center justify-center gap-2 px-4 py-8 text-sm text-[#124d56]/50">
                              <Loader2
                                size={17}
                          ...
                          {tourPackageStatus ===
                            ...
                            <div className="px-4 py-6 text-center">
                              ...
                              <button
                                ...
                                className="mt-3 rounded-lg border border-[#124d56]/15 px-3 py-2 text-xs font-medium text-[#124d56] transition hover:bg-[#F2FAFB]"
                              >
                                Try Again
                              </button>
                            </div>
                              ...
                              <div className="px-4 py-8 text-center">
                                ...
                                {packageSearch && (
                                  <button
                                    ...
                                    className="mt-2 text-xs font-medium text-[#F58634] hover:underline"
                                  >
                                    Clear search
                                  </button>
                                )}
                              ...
                              (pkg) => {
                                ...
                                return (
                                  <button
                                    ...
                                    className={`flex w-full items-center justify-between px-4 py-3 text-left text-sm transition duration-200 ${
                                      isSelected
                                        ? "bg-[#F58634]/10 text-[#F58634]"
                                        : "text-[#124d56]/80 hover:bg-[#F2FAFB] hover:text-[#124d56]"
                                    }`}
                                  >
                                    <span className="pr-4">
                                      {pkg.name}
            ...
            <div
              ref={submitMessageRef}
              className="flex min-h-125 flex-col items-center justify-center px-6 py-16 text-center"
            >
