...
export default function Destination_Quotation_Form({ onClose }) {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      const response =await createTourEnquiry(enquiryData);
      ...
      console.error(
        "Destination enquiry submission error:",
        error
      );
              ...
              >
                ...
                >
                  ...
                  <div>
                    ...
                    <label
                      className={labelClass}
                      htmlFor="destination-nationality"
                    >
                      Nationality
                    </label>
                  ...
                  >
                    ...
                    <label
                      className={labelClass}
                      htmlFor="destination-tour-package"
                    >
                      Tour Package
                    </label>
                  ...
                  <div>
                    ...
                    <label
                      className={labelClass}
                      htmlFor="destination-hotel-type"
                    >
                      Type of Hotel
                    </label>
