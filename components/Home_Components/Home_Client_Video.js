    ...
    <section className="overflow-hidden w-full py-12 border-y border-[#C9A24B]/25 bg-white px-6 md:px-14">
      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="mx-auto mb-16 max-w-xl text-center">
          ...
          <span className="text-[11px] font-['Playfair',serif] font-semibold uppercase tracking-[0.25em] text-[#B85128]">
            Client Words
          </span>

          <h2 className="mt-3 font-['Playfair_Display',serif] text-4xl font-medium text-[#173C3A] md:text-5xl">
            ...
            <div className="pointer-events-none absolute bottom-0 left-0 right-0 z-10 border-t border-white/10 bg-[#032322]/80 px-5 py-3.5 backdrop-blur-md md:px-7 md:py-4 " >
              ...
              <div className="flex items-center justify-between gap-6">
                <div className="min-w-0">
                  ...
                  <div className="font-['Noto_Sans',sans-serif] truncate text-sm font-semibold leading-tight text-white md:text-base " >
                    {currentTestimonial.name}
                  </div>
                  
                  <div className="font-['Noto_Sans',sans-serif] mt-1 truncate text-[11px] tracking-wide text-[#F58634] md:text-xs " >
                ...
                {currentTestimonial.tour && (
                  <div className="shrink-0 text-right">
                    <div className="font-['Noto_Sans',sans-serif] text-[9px] font-medium uppercase tracking-[0.2em] text-white md:text-[10px] " >
                      Tour
                    </div>
                    <div className="font-['Noto_Sans',sans-serif] mt-1 max-w-45 text-xs font-medium leading-tight text-[#F58634] md:max-w-65 md:text-sm " >
                      {currentTestimonial.tour}
                    </div>
                  </div>
                )}
