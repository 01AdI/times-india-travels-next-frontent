...
export default function Home_Client_Testimonials({ initialTestimonials = [] }) {
  ...
  const visibleReviews = testimonials.slice(
    ...
    safeCurrentPage * CARDS_PER_PAGE + CARDS_PER_PAGE
  );
    ...
    <section className="relative overflow-hidden bg-[#FAF5EB] py-12">
      ...
      <div className="relative mx-auto max-w-6xl px-6">
        ...
        <div className="mx-auto mb-16 max-w-xl text-center">
          ...
          <p className="font-['Noto_Sans',sans-serif] mt-5 text-sm text-[#476763]/50">
            ...
            {visibleReviews.map((testimonial) => (
              ...
              >
                ...
                <div className="w-full max-w-2xl">
                  ...
                  <p className="font-['Noto_Sans',sans-serif] text-lg leading-relaxed text-[#476763]/85">
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-[15px] font-['Playfair',serif] font-semibold text-[#173C3A]">
                        {testimonial.name}
                      </p>

                      {testimonial.location && (
                        <p className="text-xs text-[#476763]/75 font-['Playfair',serif]">
                          {testimonial.location}
                        </p>
                      )}
