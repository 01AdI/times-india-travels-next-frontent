  ...
  const features = [
    {
      ...
      description:
        `We’re not just agents booking hotels on your behalf. We’re a fully approved tour operator, recognized by the Ministry of Tourism, committed to delivering travel experiences with professionalism, transparency, and responsibility.
        From carefully planned itineraries to every detail of your journey, you can travel knowing that your trip is backed by a recognized and accountable travel partner.
        Because your journey deserves more than just a booking - it deserves trust.`,
      badge: "Govt. of India Approved",
      image:
        "https://images.unsplash.com/photo-1713729991304-d0b6c328560e?q=80&w=1686&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      icon: (
        <>
          <path
    ...
    },
    {
      ...
      description:
        `Because travel doesn’t always go as planned. A delayed flight or a sudden change of plans can happen anytime.
        But when you travel with us, we’re always just a call away.You travel. We take care of the rest.`,
    ...
    },
    {
      ...
      description:
        `Every itinerary begins with a conversation, not a catalogue. We take the time to understand your pace, your interests, your travel style, and your dates - then bring it all together into a route designed around you.
         No fixed packages. No one-size-fits-all journeys. Just a thoughtfully planned trip that feels truly yours. `,
      badge: "100% Tailor-Made",
      image:
        "https://images.pexels.com/photos/8828415/pexels-photo-8828415.jpeg",
      icon: (
        <>
          <path
            d="M12 20h9"
    ...
    },
    {
      ...
      description:
        `For women travelling alone, we take extra care to make every journey feel safe, comfortable, and welcoming. From choosing trusted guides to planning the right routes, we make sure you can explore India with confidence and enjoy the experience at your own pace.`,
      badge: "Solo Traveller Care",
      image:
        "https://images.unsplash.com/photo-1517176642928-dfc2da661b3f?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      icon: (
        <>
          <path
    ...
    <section className="relative overflow-hidden bg-[#FAF5EB]  py-10 sm:py-12 lg:py-12">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 sm:px-8 lg:px-10">
        <div className="mx-auto max-w-3xl text-center">
          <p className="font-['Playfair',serif] text-[10px] font-semibold uppercase tracking-[0.35em] text-[#B85128]">
            travel with us
          </p>

          <h2 className="mt-5 font-['Playfair_Display',serif] text-4xl font-medium leading-tight text-[#173C3A] sm:text-5xl md:text-6xl">
            Why Choose Us
          </h2>

          <div className="mx-auto mt-7 h-px w-40 bg-[#F58634]" />

          <p className="mx-auto mt-7 max-w-2xl font-['Noto_Sans',sans-serif] text-sm leading-7 text-[#476763] sm:text-base">
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    >
                      <p className="font-['Playfair',serif] text-[10px] font-semibold uppercase tracking-[0.25em] text-[#B85128]">
                        {feature.eyebrow}
                      </p>

                      <h3 className="mt-4 font-['Playfair_Display',serif] text-3xl font-medium leading-tight text-[#173C3A] sm:text-4xl">
                        {feature.headline}
                      </h3>

                      <p className="mt-6 max-w-lg font-['Noto_Sans',sans-serif] text-sm leading-7 text-[#476763]/80 sm:text-[15px]">
                        {feature.description}
                      </p>

                      <div className="mt-8">
                        <div className="group/badge inline-flex items-center gap-3 rounded-full border border-[#F58634]/35 bg-[#F58634]/6 px-4 py-2.5 shadow-[0_10px_30px_-15px_rgba(245,134,52,0.4)] transition-all duration-500 hover:border-[#F58634]/55 hover:bg-[#F58634]/10">
        ...
        <div className="relative mt-24 overflow-hidden rounded-4xl border border-[#173C3A]/10 bg-white/30 px-7 py-12 text-center shadow-[0_20px_60px_-40px_rgba(23,60,58,0.25)] sm:mt-28 sm:px-10 sm:py-14">
          ...
          <h3 className="mx-auto mt-4 max-w-2xl font-['Playfair_Display',serif] text-3xl font-medium leading-tight text-[#173C3A] sm:text-4xl">
