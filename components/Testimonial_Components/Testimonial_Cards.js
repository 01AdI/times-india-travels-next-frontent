...
export default function Testimonial_Cards({ initialTestimonials = [] }) {
  ...
  if (status === "loading" && reviews.length === 0) {
    return (
      <section className="relative bg-[#FAF5EB] py-20 sm:py-24 lg:py-28">
    ...
    <section className="relative bg-[#FAF5EB] py-20 sm:py-24 lg:py-28">
      <div className="mx-auto max-w-7xl px-6 sm:px-8 lg:px-10">
        ...
        <div className="mx-auto mb-16 max-w-2xl text-center">
          <p className="font-['Inter'] text-[10px] font-medium uppercase tracking-[0.3em] text-[#B85128]">
            From Our Travellers
          </p>

          <h2 className="mt-4 font-['Fraunces'] text-4xl font-medium tracking-tight text-[#173C3A] sm:text-5xl">
            Stories Worth Remembering
          </h2>

          <div className="mx-auto mt-6 h-0.5 w-25 bg-[#F58634]" />

          <p className="mx-auto mt-6 max-w-xl font-['Inter'] text-sm font-light leading-7 text-[#476763]">
