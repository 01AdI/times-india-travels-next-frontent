...
export default function Testimonial_CTA() {
  ...
  return (
    <>
      <section className="relative overflow-hidden bg-[#124d56] py-24 sm:py-28">
        ...
        <div className="relative mx-auto max-w-3xl px-6 text-center">
          ...
          {/* Heading */}
          <h2 className="mt-4 font-['Fraunces'] text-4xl font-medium leading-tight text-white sm:text-5xl md:text-6xl">
          ...
          {/* Accent */}
          <div
            className="mx-auto mt-6 h-0.5 w-30 rounded-full bg-[#F58634]"
            aria-hidden="true"
          />
          ...
          <button
            ...
            className="group mt-9 inline-flex cursor-pointer items-center gap-3 rounded-full bg-[#F58634] px-7 py-3.5 font-['Inter'] text-[12px] font-semibold uppercase tracking-[0.14em] text-white shadow-[0_12px_30px_-12px_rgba(18,49,56,0.45)] transition-all duration-300 hover:-translate-y-0.5 hover:bg-[#0B3C49] hover:shadow-[0_18px_35px_-12px_rgba(18,49,56,0.5)]"
          >
            Start Planning Your Journey

            <span className="flex h-7 w-7 items-center justify-center rounded-full bg-[#123138] transition-transform duration-300 group-hover:translate-x-1">
              <ArrowRight className="h-3.5 w-3.5 text-white" />
            </span>
          </button>

          {/* Supporting text */}
          <p className="mt-8 font-['Inter'] text-[12px] tracking-wide text-cyan-300">
