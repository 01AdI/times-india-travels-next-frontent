export default function Wonders_Hero() {
  return (
    <section
      ...
      style={{
        backgroundImage:
          "url('https://images.unsplash.com/photo-1651409473299-d1e6e326cbf4?q=80&w=764&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')",
      }}
    >
      ...
      <div className="relative z-10 text-center px-6 -mt-4">
        ...
        <p className="font-['Playfair',serif] mt-5 max-w-xl mx-auto text-sm sm:text-base text-white/90 font-light tracking-wide leading-relaxed">
          From timeless cities and royal palaces to peaceful mountains and tropical shores, discover the many sides of India in one unforgettable journey.
        </p>
      </div>
